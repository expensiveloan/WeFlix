...
const Landing: React.FC = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white">
      ...
      {/* Features Section */}
      <div className="py-12 lg:py-24 bg-gradient-to-b from-black via-gray-900 to-black relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="text-center mb-12 lg:mb-20">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold mb-4 lg:mb-6 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
              Why Choose WeFlix?
            </h2>
            <p className="text-base lg:text-xl text-gray-400 max-w-3xl mx-auto px-4">
              Experience entertainment like never before with our cutting-edge streaming platform
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            <div className="group text-center p-6 lg:p-8 rounded-2xl bg-gradient-to-b from-gray-800/50 to-gray-900/50 backdrop-blur-sm border border-gray-700/50 hover:border-red-500/50 transition-all duration-300 hover:transform hover:scale-105">
      ...
      {/* CTA Section */}
      <div className="py-12 lg:py-24 bg-gradient-to-r from-red-900/20 via-black to-red-900/20 relative overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-gradient-to-r from-red-600/5 via-transparent to-red-600/5"></div>
        </div>
        <div className="relative max-w-5xl mx-auto text-center px-4">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold mb-6 lg:mb-8 bg-gradient-to-r from-white via-gray-100 to-white bg-clip-text text-transparent">
            Ready to Begin Your Journey?
          </h2>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-300 mb-8 lg:mb-12 max-w-3xl mx-auto">
