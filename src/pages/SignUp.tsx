  ...
  if (success) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 flex items-center justify-center">
        <div className="bg-gradient-to-b from-gray-900/90 to-black/90 backdrop-blur-xl p-8 md:p-12 rounded-3xl shadow-2xl border border-gray-700/50 text-center max-w-lg mx-4">
          <div className="mb-6">
            <div className="bg-gradient-to-r from-green-500 to-emerald-500 w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-4 animate-pulse">
              <Check className="h-10 w-10 text-white" />
            </div>
            <Sparkles className="h-8 w-8 text-yellow-400 mx-auto animate-bounce" />
          </div>
          <h2 className="text-white text-3xl font-bold mb-4 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">Check Your Email!</h2>
          ...
          <div className="bg-gradient-to-r from-yellow-500/20 to-orange-500/20 border border-yellow-500/50 rounded-xl p-4 mb-6 backdrop-blur-sm">
          ...
          <Link
            to="/login"
            className="group w-full bg-gradient-to-r from-red-600 to-red-700 text-white px-8 py-4 rounded-xl font-semibold hover:from-red-700 hover:to-red-800 transition-all duration-300 transform hover:scale-105 shadow-lg flex items-center justify-center space-x-2"
          >
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 flex flex-col">
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(135deg, rgba(0,0,0,0.85) 0%, rgba(15,23,42,0.95) 50%, rgba(0,0,0,0.85) 100%), url('https://images.pexels.com/photos/109669/pexels-photo-109669.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080&fit=crop')`
        }}
      >
        ...
        <div className="relative z-10 bg-gradient-to-b from-gray-900/90 to-black/90 backdrop-blur-xl p-8 md:p-12 rounded-3xl shadow-2xl border border-gray-700/50 w-full max-w-lg mx-4">
          <div className="text-center mb-8">
            <h1 className="text-white text-4xl font-bold mb-2 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">Join WeFlix</h1>
            <p className="text-gray-400">Start your entertainment journey today</p>
          </div>
          ...
          <div className="mt-8 text-center space-y-4">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-gradient-to-b from-gray-900/90 to-black/90 text-gray-400">Already have an account?</span>
              </div>
            </div>
            <Link 
              to="/login" 
