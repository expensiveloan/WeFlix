  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 flex flex-col">
      ...
      >
        ...
        <div className="relative z-10 bg-gradient-to-b from-gray-900/90 to-black/90 backdrop-blur-xl p-6 lg:p-8 xl:p-12 rounded-2xl lg:rounded-3xl shadow-2xl border border-gray-700/50 w-full max-w-lg mx-4">
          <div className="text-center mb-6 lg:mb-8">
            <h1 className="text-white text-2xl lg:text-3xl xl:text-4xl font-bold mb-2 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">Join WeFlix</h1>
