  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 flex flex-col">
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(135deg, rgba(0,0,0,0.85) 0%, rgba(15,23,42,0.95) 50%, rgba(0,0,0,0.85) 100%), url('https://images.unsplash.com/photo-1489599511986-c2e2b0b5e7e4?auto=format&fit=crop&w=1920&h=1080&q=80')`
        }}
      >
